...
def change_path_dirrectory():
    ...
    file = "C:\\Users\\test_qa\\webdriver\\webdriver\\selen.png"
    config_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), file)
    # filename = os.path.join(dirname, ""C:\\Users\\test_qa\\webdriver\\webdriver\\selen.png"")
    return config_file
...
def add_new_item():
    ...
    upload = driver.find_element_by_xpath(".//*[@id='tab-general']/table/tbody/tr[9]/td/table/tbody/tr[1]/td/input")
